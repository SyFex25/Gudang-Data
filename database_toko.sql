...
--
ALTER TABLE `retail_sales_facts`
  ADD CONSTRAINT `retail_sales_facts_ibfk_1` FOREIGN KEY (`date_key`) REFERENCES `date_dimension` (`date_key`),
  ADD CONSTRAINT `retail_sales_facts_ibfk_2` FOREIGN KEY (`product_key`) REFERENCES `product_dimension` (`product_key`),
  ADD CONSTRAINT `retail_sales_facts_ibfk_3` FOREIGN KEY (`store_key`) REFERENCES `store_dimension` (`store_key`),
  ADD CONSTRAINT `retail_sales_facts_ibfk_4` FOREIGN KEY (`promotion_key`) REFERENCES `promotion_dimension` (`promotion_key`),
  ADD CONSTRAINT `retail_sales_facts_ibfk_5` FOREIGN KEY (`cashier_key`) REFERENCES `cashier_dimension` (`cashier_key`),
  ADD CONSTRAINT `retail_sales_facts_ibfk_6` FOREIGN KEY (`payment_method_key`) REFERENCES `payment_method_dimension` (`payment_method_key`);
COMMIT;
